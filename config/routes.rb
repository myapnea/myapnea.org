Rails.application.routes.draw do
  ...
  # Governance
  get 'governance-policy', to: 'static#governance_policy'
  get 'patient-engagement-panel-charter', to: 'static#PEP_charter'
  get 'advisory-council-charter', to: 'static#AC_charter'

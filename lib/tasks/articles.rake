...
namespace :articles do
  ...
  task populate: :environment do
    ...
    Broadcast.where(slug: "why-do-i-have-to-sign-a-consent-form-to-participate-in-the-research-portal").first_or_create(
      ...
      description: "The goal of MyApnea is to actively engage thousands of people with sleep apnea to share health information needed for research to improve the health and wellbeing of people with apnea. To collect your information, we need your permission, which you give by signing the consent form."
    )

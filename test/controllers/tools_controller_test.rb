...
class ToolsControllerTest < ActionController::TestCase
  ...
  test "should calculate risk assessment results for stop bang parameters" do
    post :risk_assessment_results, snoring: 'yes', tiredness: 'yes', observation: 'yes', hbp: 'yes'
  ...
  test "should calculate risk assessment results for bmi parameters" do
    post :risk_assessment_results, feet: '6', inches: '5', weight: '300'
  ...
  test "should calculate risk assessment results for risk factor parameters" do
    post :risk_assessment_results, neck: 'yes', gender: 'male', age: '51'
  ...
  test "should calculate risk assessment for multiple parameters" do
    post :risk_assessment_results, snoring: 'yes', tiredness: 'yes', observation: 'yes', hbp: 'yes', feet: '6', inches: '5', weight: '300', neck: 'yes', gender: 'male', age: '51'
    assert_equal 4, assigns(:stop_score)

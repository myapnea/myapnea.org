...
class InvitesControllerTest < ActionController::TestCase
  ...
  test 'should create invite for new member' do
    ...
    assert_difference('Invite.count') do
      post :create, params: { invite: { email: 'test@test.com', for_provider: false } }
    end
  ...
  test 'should create invite for existing member' do
    login(@valid_user)
    assert_difference('Invite.count') do
      post :create, params: { invite: { email: @valid_user.email, for_provider: false } }
    end
    assert_redirected_to members_invites_path
  end
  ...
  test 'should create invite for provider' do
    login(@valid_user)
    assert_difference('Invite.count') do
      post :create, params: { invite: { email: 'test@test.com', for_provider: true } }
    end

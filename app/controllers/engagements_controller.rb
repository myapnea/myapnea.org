...
class EngagementsController < ApplicationController
  ...
  def index
    @engagements = Engagement.current
  end
  ...
  private
    ...
    def engagement_params
      params.require(:engagement).permit(:user_id, :adult_diagnosed, :adult_at_risk, :caregiver_adult, :caregiver_child, :researcher, :provider, :text, :deleted, :response_placeholder)
    end
end

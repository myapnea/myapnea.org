...
select u.id patid,
       ...
       string_agg(case when q.slug = 'sex' and at.name = 'sex' then ao.text end, ',') as raw_sex_text,
       string_agg(case when q.slug = 'sex' and at.name = 'sex' then ao.value::text end, ',') as raw_sex_value,
       ...
       string_agg(case when q.slug = 'ethnicity' and at.name = 'ethnicity' then ao.text end, ',') as raw_hispanic_text,
       string_agg(case when q.slug = 'ethnicity' and at.name = 'ethnicity' then ao.value::text end, ',') as raw_hispanic_value,
       ...
       string_agg(case when q.slug = 'race' and at.name = 'race' then ao.text end, ',') as raw_race_text,
       string_agg(case when q.slug = 'race' and at.name = 'race' then ao.value::text end, ',') as raw_race_value,
       ...
       string_agg(ans.encounter, ',') encounters

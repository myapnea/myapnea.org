...
select s.id as survey_id, q.id as question_id, av.answer_template_id as answer_template_id, count(av_ao.id) as total_count
from questions q
...
group by s.id, q.id, av.answer_template_id;

...
select s.id as survey_id, q.id as question_id, q_at.id as answer_template_id, q_ao.id as answer_option_id, coalesce(q_ao.text_value_en, q_ao.text) as answer_option
from questions q

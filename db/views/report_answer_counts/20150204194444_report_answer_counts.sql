...
select s.id as survey_id, q.id as question_id, av_ao.id as answer_option_id, count(coalesce(av_ao.text, av_ao.text_value_en)) as answer_count
from questions q
